...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.dresspreferences.plist"]) {
        enableHomebarSection = YES;
        [preferences setBool:enableHomebarSection forKey:@"EnableHomebarSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableHomebarSection"]) {
        enableHomebarSection = YES;
        [preferences setBool:enableHomebarSection forKey:@"EnableHomebarSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableHomebarSection"] isEqual:@(NO)]) {
        enableHomebarSection = YES;
        [preferences setBool:enableHomebarSection forKey:@"EnableHomebarSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableHomebarSection"] isEqual:@(YES)]) {
        enableHomebarSection = NO;
        [preferences setBool:enableHomebarSection forKey:@"EnableHomebarSection"];
