...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.dresspreferences.plist"]) {
        enablePageDotsSection = YES;
        [preferences setBool:enablePageDotsSection forKey:@"EnablePageDotsSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnablePageDotsSection"]) {
        enablePageDotsSection = YES;
        [preferences setBool:enablePageDotsSection forKey:@"EnablePageDotsSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnablePageDotsSection"] isEqual:@(NO)]) {
        enablePageDotsSection = YES;
        [preferences setBool:enablePageDotsSection forKey:@"EnablePageDotsSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnablePageDotsSection"] isEqual:@(YES)]) {
        enablePageDotsSection = NO;
        [preferences setBool:enablePageDotsSection forKey:@"EnablePageDotsSection"];
