...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.dresspreferences.plist"]) {
        enableUnlockTextSection = YES;
        [preferences setBool:enableUnlockTextSection forKey:@"EnableUnlockTextSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableUnlockTextSection"]) {
        enableUnlockTextSection = YES;
        [preferences setBool:enableUnlockTextSection forKey:@"EnableUnlockTextSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableUnlockTextSection"] isEqual:@(NO)]) {
        enableUnlockTextSection = YES;
        [preferences setBool:enableUnlockTextSection forKey:@"EnableUnlockTextSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableUnlockTextSection"] isEqual:@(YES)]) {
        enableUnlockTextSection = NO;
        [preferences setBool:enableUnlockTextSection forKey:@"EnableUnlockTextSection"];
